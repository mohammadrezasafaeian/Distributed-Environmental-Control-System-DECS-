...
### تصمیمات کلیدی طراحی
۱. **هوش متمرکز (STM32)**: منطق تصمیم‌گیری و پروفایل‌ها فقط در Master قرار دارند. نودهای توزیع‌شده به عنوان توسعه‌دهنده‌های I/O "ساده" (Dumb Extenders) طراحی شده‌اند که باعث می‌شود ارزان‌تر باشند و تعویض آن‌ها در محیط‌های سخت آسان‌تر باشد.
۲. **ورودی/خروجی توزیع‌شده (AVR)**: نودهای ATmega32 کارهای سطح پایین (ارتباط با سنسورهای 5V و سوئیچینگ رله‌های ولتاژ بالا) را انجام می‌دهند و Master 3.3V حساس را از نویز الکتریکی ایزوله می‌کنند.
...
## 🔮 بهبودهای آینده
- [ ] افزودن ذخیره‌سازی EEPROM برای حفظ تخصیص پروفایل‌ها
- [ ] پیاده‌سازی کنترل دوطرفه ESP32 ↔ STM32
- [ ] افزودن پشتیبانی از سنسور رطوبت خاک (I2C یا آنالوگ)
- [ ] پورت کردن به FreeRTOS برای مدیریت بهتر وظایف
